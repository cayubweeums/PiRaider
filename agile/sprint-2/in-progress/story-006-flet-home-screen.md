...
- [x] The home screen shows a **list of Bluetooth controllers** from `grab_all_bluetooth_interfaces()` with: controller ID and relevant capabilities (e.g. Powered, Discoverable).
- [x] No crash if radio module returns empty or error; show "not available" or empty list.
- [x] No new dependencies beyond those already in the project.
